...
touch "$home_dir/startup.sh"

#creating reminder.sh file
...
" >"$home_dir/modules/submissions.txt"

#creating submissions.txt file
...
" > "$home_dir/assets/submission.txt"
